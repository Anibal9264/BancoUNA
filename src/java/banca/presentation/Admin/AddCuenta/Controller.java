...
@WebServlet(name = "AddUserController", urlPatterns = {"/presentation/admin/addCuenta/show","/presentation/admin/addCuenta/add"})
public class Controller extends HttpServlet {

  protected void processRequest(HttpServletRequest request,HttpServletResponse response)
        throws ServletException,IOException {
        banca.presentation.Admin.addUser.Model m = (banca.presentation.Admin.addUser.Model) request.getAttribute("model");
